...
/** Forces to always include all implicitly fixed bounds and all equality
 * constraints into the initial working set when setting up an auxiliary QP. */
...
/* Uncomment the following line to activate the use of single precision
 * arithmetic. */
...
/** Macro for switching on/off the beginning of the qpOASES namespace
 * definition. */
...
enum PrintLevel {
  ...
  PL_MEDIUM, /**< Print error and warning messages as well as concise info
                messages. */
...
struct TabularOutput {
  ...
  int_t idxRemC; /**< Index of constraint that has been removed from working
                    set. */
  int_t excAddB; /**< Flag indicating whether a bound has been added to working
                    set to keep a regular projected Hessian. */
  int_t excRemB; /**< Flag indicating whether a bound has been removed from
                    working set to keep a regular projected Hessian. */
  int_t excAddC; /**< Flag indicating whether a constraint has been added to
                    working set to keep a regular projected Hessian. */
  int_t excRemC; /**< Flag indicating whether a constraint has been removed from
                    working set to keep a regular projected Hessian. */
};
