...
public:
  ...
  real_t getKktViolation(
      QProblemB* const qp, /**< QProblemB to be analysed. */
      real_t* const maxStat =
          0, /**< Output: maximum value of stationarity condition residual. */
      real_t* const maxFeas =
          0, /**< Output: maximum value of primal feasibility violation. */
      real_t* const maxCmpl =
          0 /**< Output: maximum value of complementarity residual. */
      ) const;
   ...
   *	\return Maximum violation of the KKT conditions (or INFTY on error). */
  real_t getKktViolation(
      QProblem* const qp, /**< QProblem to be analysed. */
      real_t* const maxStat =
          0, /**< Output: maximum value of stationarity condition residual. */
      real_t* const maxFeas =
          0, /**< Output: maximum value of primal feasibility violation. */
   ...
   *	\return Maximum violation of the KKT conditions (or INFTY on error). */
  real_t getKktViolation(
      SQProblem* const qp, /**< SQProblem to be analysed. */
      real_t* const maxStat =
          0, /**< Output: maximum value of stationarity condition residual. */
      real_t* const maxFeas =
          0, /**< Output: maximum value of primal feasibility violation. */
  ...
  returnValue getVarianceCovariance(
      QProblemB* const qp,            /**< QProblemB to be analysed. */
      const real_t* const g_b_bA_VAR, /**< Input:  Variance-covariance of g, the
                                       *bounds lb and ub, and lbA and ubA
                                       *respectively. Dimension: 2nV x 2nV */
      real_t* const Primal_Dual_VAR   /**< Output: The result for the
                                       *variance-covariance of the primal and dual
                                       *variables. Dimension: 2nV x 2nV */
      ) const;
  ...
  returnValue getVarianceCovariance(
      QProblem* const qp, /**< QProblem to be analysed. */
      const real_t* const
          g_b_bA_VAR, /**< Input:  Variance-covariance of g, the bounds
                       *lb and ub, and lbA and ubA respectively.
                       *Dimension:  (2nV+nC) x (2nV+nC) */
      real_t* const
          Primal_Dual_VAR /**< Output: The result for the
                           *variance-covariance of the primal and dual
                           *variables. Dimension:  (2nV+nC) x (2nV+nC) */
      ) const;
  ...
  /** Checks if a direction of negative curvature shows up if we remove all
   * bounds that just recently became active */
...
#include "modules/common/math/qp_problem/extras/SolutionAnalysis.ipp"
