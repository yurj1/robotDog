 ...
 *  This function allocates the required memory for all data; after successfully
 calling it,
...
returnValue solveOqpBenchmark(
    ...
    BooleanType isSparse, /**< Shall convert matrices to sparse format before
                             solution? */
    const Options& options, /**< QP solver options to be used while solving
                               benchmark problems. */
    int_t& nWSR, /**< Input: Maximum number of working set recalculations; \n
                                          Output: Maximum number of performed
                    working set recalculations. */
    real_t& maxCPUtime, /**< Output: Maximum CPU time required for solving each
                           QP. */
    real_t& maxStationarity, /**< Output: Maximum residual of stationarity
                                condition. */
    real_t& maxFeasibility,  /**< Output: Maximum residual of primal feasibility
                                condition. */
    real_t& maxComplementarity /**< Output: Maximum residual of complementarity
                                  condition. */
);
...
returnValue solveOqpBenchmark(
    ...
    const Options& options,   /**< QP solver options to be used while solving
                                 benchmark problems. */
    int_t maxAllowedNWSR, /**< Maximum number of working set recalculations to
                             be performed. */
    real_t& maxNWSR,      /**< Output: Maximum number of performed working set
                             recalculations. */
    real_t& avgNWSR,      /**< Output: Average number of performed working set
                             recalculations. */
    real_t& maxCPUtime, /**< Output: Maximum CPU time required for solving each
                           QP. */
    real_t& avgCPUtime, /**< Output: Average CPU time required for solving each
                           QP. */
    real_t& maxStationarity, /**< Output: Maximum residual of stationarity
                                condition. */
    real_t& maxFeasibility,  /**< Output: Maximum residual of primal feasibility
 ...
 * \return SUCCESSFUL_RETURN \n
                   ...
                   RET_BENCHMARK_ABORTED */
returnValue runOqpBenchmark(
    const char* path,          /**< Full path of the benchmark files (without
                                  trailing slash!). */
    BooleanType isSparse,      /**< Shall convert matrices to sparse
                                  format before solution? */
    const Options& options,    /**< QP solver options to be used while
                                  solving benchmark problems. */
    int_t& nWSR,               /**< Input: Maximum number of working set
                                  recalculations; \n        Output: Maximum number
                                  of        performed working set recalculations. */
    real_t& maxCPUtime,        /**< Output: Maximum CPU time required for
                                  solving each QP. */
    real_t& maxStationarity,   /**< Output: Maximum residual of
                                  stationarity condition. */
    real_t& maxFeasibility,    /**< Output: Maximum residual of primal
                                  feasibility condition. */
    real_t& maxComplementarity /**< Output: Maximum residual of
 ...
 * \return SUCCESSFUL_RETURN \n
                   ...
                   RET_BENCHMARK_ABORTED */
returnValue runOqpBenchmark(
    const char* path, /**< Full path of the benchmark files (without trailing
                         slash!). */
    BooleanType isSparse, /**< Shall convert matrices to sparse format before
                             solution? */
    BooleanType useHotstarts, /**< Shall QP solution be hotstarted? */
