 ...
 *	B o u n d s
 */
Bounds::Bounds(int_t _n) : SubjectTo(_n) { init(_n); }

/*
 *	B o u n d s
 */
Bounds::Bounds(const Bounds& rhs) : SubjectTo(rhs) { copy(rhs); }
 ...
 */
returnValue Bounds::setupAllFree() { return setupAll(ST_INACTIVE); }

/*
 *	s e t u p A l l L o w e r
 */
returnValue Bounds::setupAllLower() { return setupAll(ST_LOWER); }

/*
 *	s e t u p A l l U p p e r
 */
returnValue Bounds::setupAllUpper() { return setupAll(ST_UPPER); }
 ...
 *	c l e a r
 */
returnValue Bounds::clear() { return SUCCESSFUL_RETURN; }
