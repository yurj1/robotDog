 ...
 *(thanks to Leonard Wirsching) \version 3.2 \date 2007-2017
 *
 ...
 *
 *  The enumeration returnValueType defines all symbols for global return
 *values. Important: All return values are assumed to be nonnegative!
 *
 *	\author Hans Joachim Ferreau
 */
enum returnValue {
  TERMINAL_LIST_ELEMENT =
      -1, /**< Terminal list element, internal usage only! */
  /* miscellaneous */
  ...
  /* QProblem */
  RET_QPOBJECT_NOT_SETUP, /**< The QP object has not been setup correctly, use
                             another constructor. */
  ...
  RET_INIT_FAILED_UNBOUNDEDNESS,   /**< Initial QP could not be solved due to
                                      unboundedness! */
  RET_INIT_FAILED_REGULARISATION,  /**< Initialisation failed as Hessian matrix
  ...
  RET_NO_CHOLESKY_WITH_INITIAL_GUESS, /**< Externally computed Cholesky factor
                                         cannot be combined with an initial
                                         guess. */
  RET_NO_EXTERN_SOLVER,               /**< No extern QP solver available. */
  RET_QP_UNBOUNDED,                   /**< QP is unbounded. */
  RET_QP_INFEASIBLE,                  /**< QP is infeasible. */
  RET_QP_NOT_SOLVED,      /**< Problems occurred while solving QP with standard
                             solver. */
  ...
  RET_SHIFT_DETERMINATION_FAILED, /**< Determination of shift of the QP data
                                     failed. */
  ...
  RET_CYCLING_NOT_RESOLVED,      /**< Cycling cannot be resolved, QP probably
                                    infeasible. */
  ...
  RET_LINEARLY_INDEPENDENT, /**< New bound/constraint is linearly independent.
                             */
  RET_LI_RESOLVED,          /**< Linear independence of active constraint matrix
                               successfully resolved. (90) */
  RET_ENSURELI_FAILED,      /**< Failed to ensure linear independence of active
                               constraint matrix. */
  ...
  RET_ALL_BOUNDS_ACTIVE,     /**< All bounds are active, no further bound can be
                                added. */
  ...
  RET_MATRIX_FACTORISATION_FAILED,  /**< Unable to calculate new matrix
                                       factorisations. */
  RET_PRINT_ITERATION_FAILED,       /**< Unable to print information on current
                                       iteration. */
  RET_NO_GLOBAL_MESSAGE_OUTPUTFILE, /**< No global message output file
                                       initialised. */
  ...
  RET_USING_REGULARISATION, /**< Using regularisation as Hessian matrix is not
                               positive definite. (110) */
  RET_EPS_MUST_BE_POSITVE,  /**< Eps for regularisation must be sufficiently
                               positive. */
  RET_REGSTEPS_MUST_BE_POSITVE, /**< Maximum number of regularisation steps must
                                   be non-negative. */
  RET_HESSIAN_ALREADY_REGULARISED, /**< Hessian has been already regularised. */
  RET_CANNOT_REGULARISE_IDENTITY,  /**< Identity Hessian matrix cannot be
                                      regularised. */
  RET_CANNOT_REGULARISE_SPARSE,    /**< Sparse matrix cannot be regularised as
                                      diagonal entry is missing. */
  RET_NO_REGSTEP_NWSR, /**< No additional regularisation step could be performed
                          due to limits. */
  RET_FEWER_REGSTEPS_NWSR, /**< Fewer additional regularisation steps have been
                              performed due to limits. */
  RET_CHOLESKY_OF_ZERO_HESSIAN, /**< Cholesky decomposition of (unregularised)
                                   zero Hessian matrix. */
  RET_ZERO_HESSIAN_ASSUMED,     /**< Zero Hessian matrix assumed as null pointer
                                   passed without specifying hessianType. */
  RET_CONSTRAINTS_ARE_NOT_SCALED, /**< (no longer in use) (120) */
  RET_INITIAL_BOUNDS_STATUS_NYI,  /**< (no longer in use) */
  RET_ERROR_IN_CONSTRAINTPRODUCT, /**< Error in user-defined constraint product
                                     function. */
  RET_FIX_BOUNDS_FOR_LP, /**< All initial bounds must be fixed when solving an
                            (unregularised) LP. */
  RET_USE_REGULARISATION_FOR_LP, /**< Set options.enableRegularisation=BT_TRUE
                                    for solving LPs. */
  /* SQProblem */
  RET_UPDATEMATRICES_FAILED, /**< Unable to update QP matrices. */
  RET_UPDATEMATRICES_FAILED_AS_QP_NOT_SOLVED, /**< Unable to update matrices as
                                                 previous QP is not solved. */
  /* Utils */
  ...
  /* Options */
  RET_OPTIONS_ADJUSTED, /**< Options needed to be adjusted for consistency
                           reasons. */
  /* SolutionAnalysis */
  ...
  /* Sparse matrices */
  RET_NO_DIAGONAL_AVAILABLE,    /**< Sparse matrix does not have entries on full
                                   diagonal. */
  RET_DIAGONAL_NOT_INITIALISED, /**< Diagonal data of sparse matrix has not been
                                   initialised. (140) */
  /* Dropping of infeasible constraints */
  RET_ENSURELI_DROPPED, /**< Linear independence resolved by dropping blocking
                           constraint. */
  ...
  RET_QR_FACTORISATION_FAILED, /**< QR factorization of Schur complement failed.
                                */
  RET_INERTIA_CORRECTION_FAILED, /**< Inertia correction failed after KKT matrix
                                    had too many negative eigenvalues. */
  RET_NO_SPARSE_SOLVER, /**< No factorization routine for the KKT matrix
                           installed. */
  /* Simple exitflags */
  RET_SIMPLE_STATUS_P1, /**< QP problem could not be solved within given number
                           of iterations. */
  RET_SIMPLE_STATUS_P0, /**< QP problem solved. */
  RET_SIMPLE_STATUS_M1, /**< QP problem could not be solved due to an internal
                           error. */
  RET_SIMPLE_STATUS_M2, /**< QP problem is infeasible (and thus could not be
                           solved). */
  RET_SIMPLE_STATUS_M3  /**< QP problem is unbounded (and thus could not be
                           solved). (150) */
};

/**
 *	\brief Handles all kind of error messages, warnings and other
 *information.
 *
 *	This class handles all kinds of messages (errors, warnings, infos)
 *initiated by qpOASES modules and stores the corresponding global preferences.
 *
...
public:
  ...
  typedef struct {
    ...
    VisibilityStatus
        globalVisibilityStatus; /**< Determines if message can be printed.
                                 * 	 If this value is set to VS_HIDDEN, no
                                 * message is printed! */
  } ReturnValueList;
...
public:
  ...
  /** Constructor which takes the desired output file and desired visibility
   * states. */
  MessageHandling(
   ...
   * \n Errors are defined as abnormal events which cause an immediate
   * termination of the current (sub) function. Errors of a sub function should
   * be commented by the calling function by means of a warning message (if this
   * error does not cause an error of the calling function, either)! \return
  ...
  returnValue throwError(
      ...
      const unsigned long linenumber, /**< Number of line which caused the
                                         error.incompatible binary file */
      VisibilityStatus
          localVisibilityStatus /**< Determines (locally) if error message can
                                 * be printed to stdFile. If GLOBAL visibility
                                 * status of the message is set to VS_HIDDEN,
                                 *   no message is printed, anyway! */
  );

  /** Prints a warning message (a simplified macro THROWWARNING is also
   * provided). Warnings are definied as abnormal events which does NOT cause an
   * immediate termination of the current (sub) function. \return Warning number
   * returned by sub function call
   */
  returnValue throwWarning(
      ...
      VisibilityStatus
          localVisibilityStatus /**< Determines (locally) if warning message can
                                 * be printed to stdFile. If GLOBAL visibility
                                 * status of the message is set to VS_HIDDEN,
                                 *   no message is printed, anyway! */
  );
  ...
  returnValue throwInfo(
      ...
      VisibilityStatus
          localVisibilityStatus /**< Determines (locally) if info message can be
                                 * printed to stdFile. If GLOBAL visibility
                                 * status of the message is set to VS_HIDDEN,
                                 *   no message is printed, anyway! */
  );
  ...
  inline void
  setOutputFile(FILE* _outputFile /**< New output file for messages. */
  );
  ...
  inline returnValue
  setErrorCount(int_t _errorCount /**< New error count value. */
  );
...
protected:
  ...
  returnValue throwMessage(
      returnValue RETnumber,      /**< Error/warning/info number returned by sub
                                     function call. */
      const char* additionaltext, /**< Additional warning text (0, if none). */
      const char* functionname,   /**< Name of function which caused the
                                     error/warning/info. */
      const char*
      ...
      const unsigned long linenumber, /**< Number of line which caused the
                                         error/warning/info. */
      VisibilityStatus
          localVisibilityStatus, /**< Determines (locally) if info message can
                                  * be printed to stdFile. If GLOBAL visibility
                                  * status of the message is set to VS_HIDDEN,
                                  *   no message is printed, anyway! */
      const char*
...
#define THROWERROR(retval)                                                     \
  (getGlobalMessageHandler()->throwError((retval), 0, __FUNC__, __FILE__,      \
                                         __LINE__, VS_VISIBLE))

/** Short version of throwWarning with default values, only returnValue is
 * needed */
#define THROWWARNING(retval)                                                   \
  (getGlobalMessageHandler()->throwWarning((retval), 0, __FUNC__, __FILE__,    \
                                           __LINE__, VS_VISIBLE))

/** Short version of throwInfo with default values, only returnValue is needed
 */
#define THROWINFO(retval)                                                      \
  (getGlobalMessageHandler()->throwInfo((retval), 0, __FUNC__, __FILE__,       \
                                        __LINE__, VS_VISIBLE))
