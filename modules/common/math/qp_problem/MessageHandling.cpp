 ...
 *	\date 2007-2017
 *
 *	Implementation of the MessageHandling class including global return
 *values.
 *
 */
...
#include "modules/common/math/qp_problem/MessageHandling.hpp"
...
MessageHandling::ReturnValueList returnValueList[] = {
    ...
    {RET_AVAILABLE_WITH_LINUX_ONLY,
     "This function is available under Linux only", VS_HIDDEN},
    ...
    {RET_INDEXLIST_EXCEEDS_MAX_LENGTH,
     "Index list exceeds its maximal physical length", VS_VISIBLE},
    ...
    {RET_INDEXLIST_INTERSECT_FAILED,
     "Intersection with another index set failed", VS_VISIBLE},
    ...
    {RET_MOVING_CONSTRAINT_FAILED,
     "Moving constraint between index sets failed", VS_VISIBLE},
    ...
    {RET_NO_INIT_WITH_STANDARD_SOLVER,
     "Initialisation via extern QP solver is not yet implemented", VS_VISIBLE},
    ...
    {RET_INIT_FAILED_CHOLESKY,
     "Initialisation failed due to Cholesky decomposition", VS_VISIBLE},
    {RET_INIT_FAILED_HOTSTART, "Initialisation failed! QP could not be solved!",
     VS_VISIBLE},
    {RET_INIT_FAILED_INFEASIBILITY,
     "Initial QP could not be solved due to infeasibility!", VS_VISIBLE},
    {RET_INIT_FAILED_UNBOUNDEDNESS,
     "Initial QP could not be solved due to unboundedness!", VS_VISIBLE},
    ...
    {RET_OBTAINING_WORKINGSET_FAILED,
     "Failed to obtain working set for auxiliary QP", VS_VISIBLE},
    {RET_SETUP_WORKINGSET_FAILED,
     "Failed to setup working set for auxiliary QP", VS_VISIBLE},
    {RET_SETUP_AUXILIARYQP_FAILED,
     "Failed to setup auxiliary QP for initialised homotopy", VS_VISIBLE},
    {RET_NO_CHOLESKY_WITH_INITIAL_GUESS,
     "Externally computed Cholesky factor cannot be combined with an initial "
     "guess",
     VS_VISIBLE},
    ...
    {RET_HOTSTART_FAILED_AS_QP_NOT_INITIALISED,
     "Unable to perform homotopy as previous QP is not solved", VS_VISIBLE},
    {RET_ITERATION_STARTED, "Iteration", VS_VISIBLE},
    {RET_SHIFT_DETERMINATION_FAILED,
     "Determination of shift of the QP data failed", VS_VISIBLE},
    {RET_STEPDIRECTION_DETERMINATION_FAILED,
     "Determination of step direction failed", VS_VISIBLE},
    ...
    {RET_HOTSTART_STOPPED_INFEASIBILITY,
     "Premature homotopy termination because QP is infeasible", VS_VISIBLE},
    {RET_HOTSTART_STOPPED_UNBOUNDEDNESS,
     "Premature homotopy termination because QP is unbounded", VS_VISIBLE},
    {RET_WORKINGSET_UPDATE_FAILED,
     "Unable to update working sets according to initial guesses", VS_VISIBLE},
    {RET_MAX_NWSR_REACHED,
     "Maximum number of working set recalculations performed", VS_VISIBLE},
    ...
    {RET_STEPDIRECTION_FAILED_TQ,
     "Abnormal termination due to TQ factorisation", VS_VISIBLE},
    {RET_STEPDIRECTION_FAILED_CHOLESKY,
     "Abnormal termination due to Cholesky factorisation", VS_VISIBLE},
    {RET_CYCLING_DETECTED, "Cycling detected", VS_VISIBLE},
    {RET_CYCLING_NOT_RESOLVED,
     "Cycling cannot be resolved, QP is probably infeasible", VS_VISIBLE},
    ...
    {RET_ADDCONSTRAINT_FAILED_INFEASIBILITY,
     "Addition of constraint to working set failed", VS_VISIBLE},
    {RET_ADDBOUND_FAILED, "Addition of bound to working set failed",
     VS_VISIBLE},
    {RET_ADDBOUND_FAILED_INFEASIBILITY,
     "Addition of bound to working set failed", VS_VISIBLE},
    {RET_REMOVECONSTRAINT_FAILED,
     "Removal of constraint from working set failed", VS_VISIBLE},
    ...
    {RET_LINEARLY_INDEPENDENT, "New bound/constraint is linearly independent",
     VS_VISIBLE},
    {RET_LI_RESOLVED,
     "Linear independence of active constraint matrix successfully resolved",
     VS_VISIBLE},
    {RET_ENSURELI_FAILED,
    ...
    {RET_ALL_BOUNDS_ACTIVE,
     "All bounds are active, no further bound can be added", VS_VISIBLE},
    ...
    {RET_MATRIX_SHIFT_FAILED,
     "Unable to update matrices or to transform vectors", VS_VISIBLE},
    {RET_MATRIX_FACTORISATION_FAILED,
     "Unable to calculate new matrix factorisations", VS_VISIBLE},
    {RET_PRINT_ITERATION_FAILED,
     "Unable to print information on current iteration", VS_VISIBLE},
    {RET_NO_GLOBAL_MESSAGE_OUTPUTFILE,
     "No global message output file initialised", VS_VISIBLE},
    {RET_DISABLECONSTRAINTS_FAILED, "Unable to disable constraints",
     VS_VISIBLE},
    ...
    {RET_USING_REGULARISATION,
     "Using regularisation as Hessian matrix is not positive definite",
     VS_VISIBLE},
    {RET_EPS_MUST_BE_POSITVE,
     "Eps for regularisation must be sufficiently positive", VS_VISIBLE},
    {RET_REGSTEPS_MUST_BE_POSITVE,
     "Maximum number of regularisation steps must be non-negative", VS_VISIBLE},
    {RET_HESSIAN_ALREADY_REGULARISED, "Hessian has been already regularised",
     VS_VISIBLE},
    {RET_CANNOT_REGULARISE_IDENTITY,
     "Identity Hessian matrix cannot be regularised", VS_VISIBLE},
    ...
    {RET_ZERO_HESSIAN_ASSUMED,
     "Zero Hessian matrix assumed as null pointer passed without specifying "
     "hessianType",
     VS_VISIBLE},
    {RET_CONSTRAINTS_ARE_NOT_SCALED, "(should not be thrown, no longer in use)",
     VS_VISIBLE},
    {RET_INITIAL_BOUNDS_STATUS_NYI, "(should not be thrown, no longer in use)",
     VS_VISIBLE},
    {RET_ERROR_IN_CONSTRAINTPRODUCT,
     "Error in user-defined constraint product function", VS_VISIBLE},
    {RET_FIX_BOUNDS_FOR_LP,
     "All initial bounds must be fixed when solving an (unregularised) LP",
     VS_VISIBLE},
    {RET_USE_REGULARISATION_FOR_LP,
     "Set options.enableRegularisation=BT_TRUE for solving LPs", VS_VISIBLE},
    /* SQProblem */
    {RET_UPDATEMATRICES_FAILED, "Unable to update QP matrices", VS_VISIBLE},
    {RET_UPDATEMATRICES_FAILED_AS_QP_NOT_SOLVED,
     "Unable to update matrices as previous QP is not solved", VS_VISIBLE},
    /* Utils */
    ...
    {RET_OPTIONS_ADJUSTED,
     "Options needed to be adjusted for consistency reasons", VS_VISIBLE},
    /* SolutionAnalysis */
    ...
    {RET_NO_DIAGONAL_AVAILABLE,
     "Sparse matrix does not have entries on full diagonal", VS_VISIBLE},
    {RET_DIAGONAL_NOT_INITIALISED,
     "Diagonal data of sparse matrix has not been initialised", VS_VISIBLE},
    ...
    {RET_QR_FACTORISATION_FAILED, "QR factorization of Schur complement failed",
     VS_VISIBLE},
    {RET_INERTIA_CORRECTION_FAILED, "Inertia correction of KKT matrix failed",
     VS_VISIBLE},
    ...
    {RET_SIMPLE_STATUS_M3,
     "QP problem is unbounded (and thus could not be solved)", VS_VISIBLE},
...
MessageHandling::ReturnValueList
    returnValueList[1]; /* Do not use messages for embedded platforms! */
 ...
 */
returnValue
MessageHandling::throwError(returnValue Enumber, const char* additionaltext,
  ...
  if (Enumber <= SUCCESSFUL_RETURN)
    return throwError(RET_ERROR_UNDEFINED, 0, __FUNC__, __FILE__, __LINE__,
                      VS_VISIBLE);

  /* Call to common throwMessage function if error shall be displayed. */
  if (errorVisibility == VS_VISIBLE)
    return throwMessage(Enumber, additionaltext, functionname, filename,
                        linenumber, localVisibilityStatus, "ERROR");
  else
    return Enumber;
}
 ...
 */
returnValue
MessageHandling::throwWarning(returnValue Wnumber, const char* additionaltext,
                              const char* functionname, const char* filename,
                              const unsigned long linenumber,
                              VisibilityStatus localVisibilityStatus) {
  /* consistency check */
  if (Wnumber <= SUCCESSFUL_RETURN)
    return throwError(RET_WARNING_UNDEFINED, 0, __FUNC__, __FILE__, __LINE__,
                      VS_VISIBLE);

  /* Call to common throwMessage function if warning shall be displayed. */
  if (warningVisibility == VS_VISIBLE)
    return throwMessage(Wnumber, additionaltext, functionname, filename,
                        linenumber, localVisibilityStatus, "WARNING");
  else
    return Wnumber;
}
...
returnValue MessageHandling::throwInfo(returnValue Inumber,
  ...
  if (Inumber < SUCCESSFUL_RETURN)
    return throwError(RET_INFO_UNDEFINED, 0, __FUNC__, __FILE__, __LINE__,
                      VS_VISIBLE);

  /* Call to common throwMessage function if info shall be displayed. */
  if (infoVisibility == VS_VISIBLE)
    return throwMessage(Inumber, additionaltext, functionname, filename,
                        linenumber, localVisibilityStatus, "INFO");
  else
    return Inumber;
}
...
returnValue MessageHandling::throwMessage(
    returnValue RETnumber, const char* additionaltext, const char* functionname,
    const char* filename, const unsigned long linenumber,
    VisibilityStatus localVisibilityStatus, const char* RETstring) {
#ifndef __SUPPRESSANYOUTPUT__
  ...
  if ((returnValueList[keypos].globalVisibilityStatus == VS_VISIBLE) &&
    ...
    if (additionaltext == 0) {
      ...
      snprintf(myPrintfString, MAX_STRING_LENGTH, "%s (%s, %s:%d): \t%s\n",
               RETstring, functionname, filename, (int_t)linenumber,
               returnValueList[keypos].data);
#else
      ...
      snprintf(myPrintfString, MAX_STRING_LENGTH, "%s (%s, %s:%d): \t%s %s\n",
               RETstring, functionname, filename, (int_t)linenumber,
               returnValueList[keypos].data, additionaltext);
#else
...
const char*
MessageHandling::getErrorCodeMessage(const returnValue _returnValue) {
#ifndef __SUPPRESSANYOUTPUT__
  ...
  return (returnValueList[keypos].data != 0) ? returnValueList[keypos].data
...
static MessageHandling globalMessageHandler(stdFile, VS_VISIBLE, VS_HIDDEN,
                                            VS_HIDDEN);
#endif
...
MessageHandling* getGlobalMessageHandler() {
  ...
  static MessageHandling globalMessageHandler(stdFile, VS_VISIBLE, VS_VISIBLE,
                                              VS_VISIBLE);
#endif /* __DSPACE__ */
#endif /* __XPCTARGET__ */
