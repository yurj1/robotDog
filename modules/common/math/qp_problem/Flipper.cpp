 ...
 *	g e t
 */
returnValue Flipper::get(Bounds* const _bounds, real_t* const _R,
                         Constraints* const _constraints, real_t* const _Q,
                         real_t* const _T) const {
  if (_bounds != 0)
    *_bounds = bounds;
...
returnValue Flipper::set(const Bounds* const _bounds, const real_t* const _R,
                         ...
                         const real_t* const _Q, const real_t* const _T) {
  if (_bounds != 0)
    bounds = *_bounds;
