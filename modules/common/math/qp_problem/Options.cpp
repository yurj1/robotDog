 ...
 *	s e t T o F a s t
 */
returnValue Options::setToFast() { return setToMPC(); }
...
returnValue Options::print() const {
  ...
  int ret1 = snprintf(myPrintfString, MAX_STRING_LENGTH,
                      "printLevel                     =  %s\n", info);
  if (ret1 < 0) {
    abort();
  }
  ...
  int ret2 = snprintf(myPrintfString, MAX_STRING_LENGTH,
                      "enableRamping                  =  %s\n", info);
  if (ret2 < 0) {
    abort();
  }
  ...
  int ret3 = snprintf(myPrintfString, MAX_STRING_LENGTH,
                      "enableFarBounds                =  %s\n", info);
  if (ret3 < 0) {
    abort();
  }
  ...
  int ret4 = snprintf(myPrintfString, MAX_STRING_LENGTH,
  ...
  int ret5 = snprintf(myPrintfString, MAX_STRING_LENGTH,
  ...
  int ret6 = snprintf(myPrintfString, MAX_STRING_LENGTH,
                      "enableFullLITests              =  %s\n", info);
  if (ret6 < 0) {
    abort();
  }
  ...
  int ret7 = snprintf(myPrintfString, MAX_STRING_LENGTH,
                      "enableNZCTests                 =  %s\n", info);
  if (ret7 < 0) {
    abort();
  }
  ...
  int ret8 = snprintf(myPrintfString, MAX_STRING_LENGTH,
                      "enableDriftCorrection          =  %d\n",
  ...
  int ret9 = snprintf(myPrintfString, MAX_STRING_LENGTH,
                      "enableCholeskyRefactorisation  =  %d\n",
  ...
  int ret10 = snprintf(myPrintfString, MAX_STRING_LENGTH,
                       "enableEqualities               =  %s\n", info);
  if (ret10 < 0) {
    abort();
  }
  ...
  int ret11 = snprintf(myPrintfString, MAX_STRING_LENGTH,
  ...
  int ret12 = snprintf(myPrintfString, MAX_STRING_LENGTH,
                       "rcondSMin                      =  %e\n", rcondSMin);
  if (ret12 < 0) {
    abort();
  }
  ...
  int ret16 = snprintf(myPrintfString, MAX_STRING_LENGTH,
