...
public:
   ...
   *	\return SUCCESSFUL_RETURN \n
                          ...
                          RET_INDEX_OUT_OF_BOUNDS */
  returnValue
  moveFreeToFixed(int_t number,           /**< Number of bound to be fixed. */
  ...
  returnValue
  swapFree(int_t number1, /**< Number of first constraint or bound. */
...
#include "modules/common/math/qp_problem/Bounds.ipp"
