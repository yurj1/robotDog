...
#include "common/math/osqp/include/qdldl_interface.h" // Include only this solver in the same directory

#ifdef ENABLE_MKL_PARDISO
# include "common/math/osqp/include/pardiso_interface.h"
# include "common/math/osqp/include/pardiso_loader.h"
