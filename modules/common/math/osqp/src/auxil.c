#include "common/math/osqp/include/osqp.h" // For OSQP rho update
#include "common/math/osqp/include/auxil.h"
#include "common/math/osqp/include/proj.h"
#include "common/math/osqp/include/lin_alg.h"
#include "common/math/osqp/include/constants.h"
