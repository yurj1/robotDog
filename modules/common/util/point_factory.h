...
namespace common {
namespace util {
using athena::interface::PathPoint;
using athena::interface::PointENU;
using athena::interface::SLPoint;
// using athena::interface::SpeedPoint;
class PointFactory {
public:
  ...
  static inline common::SpeedPoint ToSpeedPoint(const double s, const double t,
