...
private:
  athena::cyber::Time start_time_;
  athena::cyber::Time end_time_;
...
#define PERF_FUNCTION()                                                        \
  athena::common::util::TimerWrapper _timer_wrapper_(                          \
      athena::common::util::function_signature(AFUNC))
#define PERF_FUNCTION_WITH_NAME(func_name)                                     \
  athena::common::util::TimerWrapper _timer_wrapper_(func_name)
#define PERF_FUNCTION_WITH_INDICATOR(indicator)                                \
  athena::common::util::TimerWrapper _timer_wrapper_(                          \
      athena::common::util::function_signature(AFUNC, indicator))
#define PERF_BLOCK_START()                                                     \
  athena::common::util::Timer _timer_;                                         \
  _timer_.Start()
