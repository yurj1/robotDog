...
/** Function needed for the generalization of toQuaternion
 * \param q a tf2_geometry_msgs::Quaternion
 * \return a copy of the same quaternion as a tf2::Quaternion
 */
inline tf2::Quaternion toQuaternion(const tf2_geometry_msgs::Quaternion& q) {
  tf2::Quaternion res;
  fromMsg(q, res);
  return res;
}
...
/** Function needed for the generalization of toQuaternion
 * \param q a tf2_geometry_msgs::QuaternionStamped
 * \return a copy of the same quaternion as a tf2::Quaternion
 */
inline tf2::Quaternion
toQuaternion(const tf2_geometry_msgs::QuaternionStamped& q) {
  tf2::Quaternion res;
