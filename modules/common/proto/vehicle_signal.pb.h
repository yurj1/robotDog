...
PROTOBUF_NAMESPACE_OPEN
template<> ::athena::common::VehicleSignal* Arena::CreateMaybeMessage<::athena::common::VehicleSignal>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace athena {
namespace common {
...
class VehicleSignal PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:athena.common.VehicleSignal) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "athena.common.VehicleSignal";
  }
  protected:
  ...
  ::athena::common::VehicleSignal_TurnSignal turn_signal() const;
  void set_turn_signal(::athena::common::VehicleSignal_TurnSignal value);
  private:
  ::athena::common::VehicleSignal_TurnSignal _internal_turn_signal() const;
  void _internal_set_turn_signal(::athena::common::VehicleSignal_TurnSignal value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:athena.common.VehicleSignal)
 private:
  class _Internal;
...
inline ::athena::common::VehicleSignal_TurnSignal VehicleSignal::_internal_turn_signal() const {
  return static_cast< ::athena::common::VehicleSignal_TurnSignal >(turn_signal_);
}
inline ::athena::common::VehicleSignal_TurnSignal VehicleSignal::turn_signal() const {
  // @@protoc_insertion_point(field_get:athena.common.VehicleSignal.turn_signal)
  return _internal_turn_signal();
}
inline void VehicleSignal::_internal_set_turn_signal(::athena::common::VehicleSignal_TurnSignal value) {
  assert(::athena::common::VehicleSignal_TurnSignal_IsValid(value));
  _has_bits_[0] |= 0x00000001u;
  turn_signal_ = value;
}
inline void VehicleSignal::set_turn_signal(::athena::common::VehicleSignal_TurnSignal value) {
  _internal_set_turn_signal(value);
  // @@protoc_insertion_point(field_set:athena.common.VehicleSignal.turn_signal)
}
...
inline bool VehicleSignal::high_beam() const {
  // @@protoc_insertion_point(field_get:athena.common.VehicleSignal.high_beam)
...
inline void VehicleSignal::set_high_beam(bool value) {
  ...
  // @@protoc_insertion_point(field_set:athena.common.VehicleSignal.high_beam)
}
...
inline bool VehicleSignal::low_beam() const {
  // @@protoc_insertion_point(field_get:athena.common.VehicleSignal.low_beam)
...
inline void VehicleSignal::set_low_beam(bool value) {
  ...
  // @@protoc_insertion_point(field_set:athena.common.VehicleSignal.low_beam)
}
...
inline bool VehicleSignal::horn() const {
  // @@protoc_insertion_point(field_get:athena.common.VehicleSignal.horn)
...
inline void VehicleSignal::set_horn(bool value) {
  ...
  // @@protoc_insertion_point(field_set:athena.common.VehicleSignal.horn)
}
...
inline bool VehicleSignal::emergency_light() const {
  // @@protoc_insertion_point(field_get:athena.common.VehicleSignal.emergency_light)
...
inline void VehicleSignal::set_emergency_light(bool value) {
  ...
  // @@protoc_insertion_point(field_set:athena.common.VehicleSignal.emergency_light)
}
...
template <> struct is_proto_enum< ::athena::common::VehicleSignal_TurnSignal> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::athena::common::VehicleSignal_TurnSignal>() {
  return ::athena::common::VehicleSignal_TurnSignal_descriptor();
}
