...
DEFINE_string(map_dir, "/athena/modules/map/data/demo",
...
DEFINE_string(monitor_config_file, "../../monitor/bin/conf/monitor/monitor.json",
              "monitor module config file");

// DEFINE_string(system_config_file, "../../monitor/bin/conf/monitor/system.json",
//               "system module config file");

// DEFINE_string(HMIMode_config_file, "../../monitor/bin/conf/monitor/hmi_mode.json",
//               "HMIMode module config file");
