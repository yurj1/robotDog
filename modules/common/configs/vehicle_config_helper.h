...
#include "modules/common/interface/vehicle_config.hpp"
...
public:
   ...
   * @param config A athena::interface::VehicleConfig class instance. The
   * athena::interface::VehicleConfig class is defined by
   * modules/common/configs/proto/vehicle_config.proto.
   */
  static void Init(const athena::interface::VehicleConfig& config);
   ...
   * @return the current athena::interface::VehicleConfig instance reference.
   */
  static const athena::interface::VehicleConfig& GetConfig();
  ...
  GetBoundingBox(const athena::interface::PathPoint& path_point);
   ...
   * @return a box2d which contains the ABCD points info.
   */
  static common::math::Box2d GetSafeBoundingBox(
    const athena::interface::PathPoint &path_point,double lon,double lat);

  static common::math::Box2d GetDirSafeBoundingBox(
    const athena::interface::PathPoint &path_point,double lon,double lat,double lat_err);

private:
  //车辆配置文件
  static json vehicle_param_json_;
  static athena::interface::VehicleConfig vehicle_config_;
