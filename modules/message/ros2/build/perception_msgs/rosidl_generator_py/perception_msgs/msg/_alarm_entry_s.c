...
bool perception_msgs__msg__alarm_entry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("perception_msgs.msg._alarm_entry.AlarmEntry", full_classname_dest, 43) == 0);
  }
  perception_msgs__msg__AlarmEntry * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of AlarmEntry */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_msgs.msg._alarm_entry");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AlarmEntry");
