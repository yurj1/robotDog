...
"""autogenerated by genpy from quad_msgs/MultiFootState.msg. Do not edit."""
import codecs
import sys
...
class MultiFootState(genpy.Message):
  _md5sum = "0ebb914d22f2140664b36ac273cb4479"
  _type = "quad_msgs/MultiFootState"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# This is a message to hold the state of all feet of a legged robot
#
...
float64 y
float64 z"""
  __slots__ = ['header','traj_index','feet']
  _slot_types = ['std_msgs/Header','uint32','quad_msgs/FootState[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MultiFootState, self).__init__(*args, **kwds)
