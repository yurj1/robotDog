...
class Gnss {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('utm_zone_num')) {
        this.utm_zone_num = initObj.utm_zone_num
      }
      else {
        this.utm_zone_num = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [utm_zone_num]
    bufferOffset = _serializer.int32(obj.utm_zone_num, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [utm_zone_num]
    data.utm_zone_num = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.utm_zone_num !== undefined) {
      resolved.utm_zone_num = msg.utm_zone_num;
    }
    else {
      resolved.utm_zone_num = 0
    }
