...
class HMIParkingStateDisplay {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HMIParkingStateDisplay(null);
  ...
  static datatype() {
    ...
    return 'ros_interface/HMIParkingStateDisplay';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HMIParkingStateDisplay(null);
...
module.exports = HMIParkingStateDisplay;
