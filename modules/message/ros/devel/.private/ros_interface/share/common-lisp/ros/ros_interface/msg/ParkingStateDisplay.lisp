...
(cl:defclass <ParkingStateDisplay> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass ParkingStateDisplay (<ParkingStateDisplay>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ParkingStateDisplay>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ParkingStateDisplay)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_interface-msg:<ParkingStateDisplay> is deprecated: use ros_interface-msg:ParkingStateDisplay instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ParkingStateDisplay>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interface-msg:header-val is deprecated.  Use ros_interface-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'parking_type-val :lambda-list '(m))
(cl:defmethod parking_type-val ((m <ParkingStateDisplay>))
...
(cl:defmethod moves_counter-val ((m <ParkingStateDisplay>))
...
(cl:defmethod remian_distance-val ((m <ParkingStateDisplay>))
...
(cl:defmethod display_info-val ((m <ParkingStateDisplay>))
...
(cl:defmethod distance_to_leader_obj-val ((m <ParkingStateDisplay>))
...
(cl:defmethod state-val ((m <ParkingStateDisplay>))
  ...
  (state m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ParkingStateDisplay>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ParkingStateDisplay>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ParkingStateDisplay>)))
  "Returns string type for a message object of type '<ParkingStateDisplay>"
  "ros_interface/ParkingStateDisplay")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ParkingStateDisplay)))
  "Returns string type for a message object of type 'ParkingStateDisplay"
  "ros_interface/ParkingStateDisplay")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ParkingStateDisplay>)))
  "Returns md5sum for a message object of type '<ParkingStateDisplay>"
  "877b72abf16a45360d8ea1120bf76726")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ParkingStateDisplay)))
  "Returns md5sum for a message object of type 'ParkingStateDisplay"
  "877b72abf16a45360d8ea1120bf76726")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ParkingStateDisplay>)))
  "Returns full string definition for message of type '<ParkingStateDisplay>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ParkingStateDisplay)))
  "Returns full string definition for message of type 'ParkingStateDisplay"
  (cl:format cl:nil "Header   header     #  ~%int32   parking_type     # 0：无效 1：垂直泊车 2：水平泊车 3：斜方泊车~%int32   moves_counter     # 揉库次数~%float64   remian_distance     # 剩余距离~%int32   display_info     # 详细信息~%float64   distance_to_leader_obj     # 距离最近障碍物距离~%int32   state     #  ~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ParkingStateDisplay>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ParkingStateDisplay>))
  "Converts a ROS message object to a list"
  (cl:list 'ParkingStateDisplay
