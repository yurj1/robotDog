...
(cl:defmethod utm_zone_num-val ((m <Gnss>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interface-msg:utm_zone_num-val is deprecated.  Use ros_interface-msg:utm_zone_num instead.")
  (utm_zone_num m))

(cl:ensure-generic-function 'utm_zone_char-val :lambda-list '(m))
(cl:defmethod utm_zone_char-val ((m <Gnss>))
...
(cl:defmethod attitude_dual-val ((m <Gnss>))
...
(cl:defmethod sd_angle_dual-val ((m <Gnss>))
...
(cl:defmethod base_line_length_dual-val ((m <Gnss>))
...
(cl:defmethod solution_status_dual-val ((m <Gnss>))
...
(cl:defmethod position_type_dual-val ((m <Gnss>))
...
(cl:defmethod solution_source_dual-val ((m <Gnss>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Gnss>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'utm_zone_num)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Gnss>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'utm_position) istream)
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'utm_zone_num) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Gnss>)))
  ...
  "cee5447731c2d35cf9bffbd23aa840f5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Gnss)))
  "Returns md5sum for a message object of type 'Gnss"
  "cee5447731c2d35cf9bffbd23aa840f5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Gnss>)))
  ...
  (cl:format cl:nil "bool   is_valid     # 数据有效性标志位~%Header   header     # 头部信息~%float64   latitude     # 纬度信息~%float64   longitude     # 经度信息~%float64   elevation     # 海拔信息~%Point3D   utm_position     # UTM坐标位置~%int32   utm_zone_num     # UTM区号~%uint8   utm_zone_char     # UTM区号~%Point3D   attitude     # 三轴姿态~%Point3D   sd_position     # 位置标准差~%Point3D   sd_velocity     # 速度标准差~%Point3D   sd_attitude     # 姿态标准差~%float64   second     # 时间~%int32   sat_use_num     # 使用卫星数~%int32   sat_in_view_num     # 可见卫星数~%uint16   solution_status     # 求解状态~%uint16   position_type     # 定位状态~%Point3D   linear_velocity     # 线速度信息~%Point3D   attitude_dual     # 双天线姿态~%Point3D   sd_angle_dual     # 双天线角度标准差~%float64   base_line_length_dual     # 双天线距离~%int32   solution_status_dual     # 双天线求解状态~%int32   position_type_dual     # 双天线定位状态~%int32   solution_source_dual     # 双天线求解源~%float64   cep68     # cep68数据位~%float64   cep95     # cep95数据位~%float64   p_dop     # pDop数据位~%float64   h_dop     # hDop数据位~%float64   v_dop     # vDop数据位~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: ros_interface/Point3D~%float64   x     # 位置坐标x~%float64   y     # 位置坐标y~%float64   z     # 位置坐标z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Gnss)))
  "Returns full string definition for message of type 'Gnss"
  (cl:format cl:nil "bool   is_valid     # 数据有效性标志位~%Header   header     # 头部信息~%float64   latitude     # 纬度信息~%float64   longitude     # 经度信息~%float64   elevation     # 海拔信息~%Point3D   utm_position     # UTM坐标位置~%int32   utm_zone_num     # UTM区号~%uint8   utm_zone_char     # UTM区号~%Point3D   attitude     # 三轴姿态~%Point3D   sd_position     # 位置标准差~%Point3D   sd_velocity     # 速度标准差~%Point3D   sd_attitude     # 姿态标准差~%float64   second     # 时间~%int32   sat_use_num     # 使用卫星数~%int32   sat_in_view_num     # 可见卫星数~%uint16   solution_status     # 求解状态~%uint16   position_type     # 定位状态~%Point3D   linear_velocity     # 线速度信息~%Point3D   attitude_dual     # 双天线姿态~%Point3D   sd_angle_dual     # 双天线角度标准差~%float64   base_line_length_dual     # 双天线距离~%int32   solution_status_dual     # 双天线求解状态~%int32   position_type_dual     # 双天线定位状态~%int32   solution_source_dual     # 双天线求解源~%float64   cep68     # cep68数据位~%float64   cep95     # cep95数据位~%float64   p_dop     # pDop数据位~%float64   h_dop     # hDop数据位~%float64   v_dop     # vDop数据位~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: ros_interface/Point3D~%float64   x     # 位置坐标x~%float64   y     # 位置坐标y~%float64   z     # 位置坐标z~%~%~%"))
