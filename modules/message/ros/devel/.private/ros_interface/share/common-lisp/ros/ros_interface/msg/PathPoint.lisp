...
(cl:defmethod cl:initialize-instance :after ((m <PathPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_interface-msg:<PathPoint> is deprecated: use ros_interface-msg:PathPoint instead.")))
...
(cl:defmethod kappa-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interface-msg:kappa-val is deprecated.  Use ros_interface-msg:kappa instead.")
  (kappa m))
...
(cl:defmethod dkappa-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interface-msg:dkappa-val is deprecated.  Use ros_interface-msg:dkappa instead.")
  (dkappa m))

(cl:ensure-generic-function 'ddkappa-val :lambda-list '(m))
(cl:defmethod ddkappa-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interface-msg:ddkappa-val is deprecated.  Use ros_interface-msg:ddkappa instead.")
  (ddkappa m))

(cl:ensure-generic-function 'lane_id-val :lambda-list '(m))
(cl:defmethod lane_id-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interface-msg:lane_id-val is deprecated.  Use ros_interface-msg:lane_id instead.")
  (lane_id m))

(cl:ensure-generic-function 'x_derivative-val :lambda-list '(m))
(cl:defmethod x_derivative-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interface-msg:x_derivative-val is deprecated.  Use ros_interface-msg:x_derivative instead.")
  (x_derivative m))

(cl:ensure-generic-function 'y_derivative-val :lambda-list '(m))
(cl:defmethod y_derivative-val ((m <PathPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interface-msg:y_derivative-val is deprecated.  Use ros_interface-msg:y_derivative instead.")
  (y_derivative m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PathPoint>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'ddkappa))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'lane_id))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PathPoint>) istream)
  "Deserializes a message object of type '<PathPoint>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'lane_id) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PathPoint>)))
  ...
  "6d7f4ed096293a13bafb904c75b6c36b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PathPoint)))
  "Returns md5sum for a message object of type 'PathPoint"
  "6d7f4ed096293a13bafb904c75b6c36b")
