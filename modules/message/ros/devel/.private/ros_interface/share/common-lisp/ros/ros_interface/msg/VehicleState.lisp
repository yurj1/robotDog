...
(cl:defclass <VehicleState> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (pose
    :reader pose
    :initarg :pose
    :type ros_interface-msg:Pose
    :initform (cl:make-instance 'ros_interface-msg:Pose))
...
(cl:defmethod cl:initialize-instance :after ((m <VehicleState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VehicleState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_interface-msg:<VehicleState> is deprecated: use ros_interface-msg:VehicleState instead.")))
...
(cl:defmethod kappa-val ((m <VehicleState>))
...
(cl:defmethod linear_acceleration-val ((m <VehicleState>))
...
(cl:defmethod driving_mode-val ((m <VehicleState>))
...
(cl:defmethod front_steering_value-val ((m <VehicleState>))
...
(cl:defmethod rear_steering_value-val ((m <VehicleState>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VehicleState>)))
  ...
  "08d2c2b080782b21d4ad592ab6471a80")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VehicleState)))
  "Returns md5sum for a message object of type 'VehicleState"
  "08d2c2b080782b21d4ad592ab6471a80")
