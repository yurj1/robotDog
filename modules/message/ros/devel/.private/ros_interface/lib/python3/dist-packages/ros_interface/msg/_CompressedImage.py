...
"""autogenerated by genpy from ros_interface/CompressedImage.msg. Do not edit."""
import codecs
import sys
...
class CompressedImage(genpy.Message):
  _md5sum = "5a93f7b86266fa4f089718ecd65118d4"
  _type = "ros_interface/CompressedImage"
...
string frame_id
"""
  __slots__ = ['header','frame_id','format','data','measurement_time','frame_type']
  _slot_types = ['std_msgs/Header','string','string','int8[]','float64','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,frame_id,format,data,measurement_time,frame_type
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_dI().pack(_x.measurement_time, _x.frame_type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.measurement_time, _x.frame_type,) = _get_struct_dI().unpack(str[start:end])
      return self
