...
"""autogenerated by genpy from ros_interface/Twist.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','ros_interface/Point3D','ros_interface/Point3D']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.linear is None:
        self.linear = ros_interface.msg.Point3D()
      if self.angular is None:
        self.angular = ros_interface.msg.Point3D()
    else:
      self.header = std_msgs.msg.Header()
      self.linear = ros_interface.msg.Point3D()
      self.angular = ros_interface.msg.Point3D()
