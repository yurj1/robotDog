...
"""autogenerated by genpy from ros_interface/Pavementype.msg. Do not edit."""
import codecs
import sys
...
class Pavementype(genpy.Message):
  _md5sum = "2ba57874d7cb9b2d8f6f058b753342d8"
  _type = "ros_interface/Pavementype"
...
string frame_id
"""
  __slots__ = ['header','type','confidence']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Pavementype, self).__init__(*args, **kwds)
