...
"""autogenerated by genpy from ros_interface/TrafficLightBox.msg. Do not edit."""
import codecs
import sys
...
class TrafficLightBox(genpy.Message):
  _md5sum = "4f1ef1a196e498958450410958317793"
  _type = "ros_interface/TrafficLightBox"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32   x     # 交通灯目标在图像上中心点横向方向像素位置
...
"""
  __slots__ = ['x','y','width','height','color','selected','camera_name']
  _slot_types = ['int32','int32','int32','int32','int32','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       x,y,width,height,color,selected,camera_name
    ...
    """
    if args or kwds:
      super(TrafficLightBox, self).__init__(*args, **kwds)
