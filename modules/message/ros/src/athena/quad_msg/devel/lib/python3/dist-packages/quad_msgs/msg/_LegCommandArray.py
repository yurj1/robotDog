...
"""autogenerated by genpy from quad_msgs/LegCommandArray.msg. Do not edit."""
import codecs
import sys
...
class LegCommandArray(genpy.Message):
  _md5sum = "021ecb87d231eeb30d1c10093fda1cef"
  _type = "quad_msgs/LegCommandArray"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# This is a message of leg commands for each leg on quad. The order is in FL, BL, FR, BR.
#
...
"""
  __slots__ = ['header','leg_commands']
  _slot_types = ['std_msgs/Header','quad_msgs/LegCommand[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LegCommandArray, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.leg_commands is None:
        self.leg_commands = []
    else:
      self.header = std_msgs.msg.Header()
      self.leg_commands = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.leg_commands)
      buff.write(_struct_I.pack(length))
      for val1 in self.leg_commands:
        _v1 = val1.header
        _x = _v1.seq
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        length = len(val1.motor_commands)
        buff.write(_struct_I.pack(length))
        for val2 in val1.motor_commands:
          _v3 = val2.header
          _x = _v3.seq
          buff.write(_get_struct_I().pack(_x))
          _v4 = _v3.stamp
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.motor_commands = []
        for i in range(0, length):
          val2 = quad_msgs.msg.MotorCommand()
          _v7 = val2.header
          start = end
          end += 4
          ...
          val1.motor_commands.append(val2)
        self.leg_commands.append(val1)
      return self
