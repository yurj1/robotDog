...
"""autogenerated by genpy from quad_msgs/MultiFootPlanContinuous.msg. Do not edit."""
import codecs
import sys
...
class MultiFootPlanContinuous(genpy.Message):
  _md5sum = "d273ca50ce913e8177d08f48b443b819"
  _type = "quad_msgs/MultiFootPlanContinuous"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# This is a message to hold a continuous foot plan for multiple robot feet
#
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','quad_msgs/MultiFootState[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MultiFootPlanContinuous, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.states:
        ...
        _x = val1.traj_index
        buff.write(_get_struct_I().pack(_x))
        length = len(val1.feet)
        buff.write(_struct_I.pack(length))
        for val2 in val1.feet:
          _v3 = val2.header
          _x = _v3.seq
          buff.write(_get_struct_I().pack(_x))
          _v4 = _v3.stamp
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = quad_msgs.msg.MultiFootState()
        _v8 = val1.header
        start = end
        end += 4
