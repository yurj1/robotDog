...
class MultiFootPlanContinuous {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.states.forEach((val) => {
      bufferOffset = MultiFootState.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MultiFootPlanContinuous(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.states[i] = MultiFootState.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.states.forEach((val) => {
      length += MultiFootState.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MultiFootPlanContinuous(null);
    ...
    if (msg.states !== undefined) {
      ...
      for (let i = 0; i < resolved.states.length; ++i) {
        resolved.states[i] = MultiFootState.Resolve(msg.states[i]);
      }
    }
    else {
      resolved.states = []
...
module.exports = MultiFootPlanContinuous;
